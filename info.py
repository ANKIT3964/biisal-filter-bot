...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1320867884 1197918807').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001954637243').split()]
...
auth_grp = environ.get('AUTH_GROUP', '-1001595200026')
